...
@app.route('/convertDecBin', methods=['GET','POST'])
def convertDecBin():
    if request.method == 'POST':
        if request.form['dec']:
            ...
            return render_template('convertDecBin.html', decimal=decimal, binary=binary, hexdecimal=hexdecimal, octdecimal=octdecimal)
            ...
            hexdecimal = hex(decimal)[2:].upper()
            return render_template('convertDecBin.html',  decimal=decimal, binary=binary, hexdecimal=hexdecimal, octdecimal=octdecimal)
    return render_template('convertDecBin.html')
